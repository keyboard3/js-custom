 ...
 * 
 * npx babel --source-root babel babel/src/transfrom-arrow-functions.js -o babel/build/transfrom-arrow-functions.js
 * source-root 表示源代码的根路径，babel 会在根目录找配置文件，刚配的 babel.config.js
 */