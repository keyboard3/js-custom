...
const commands = {
  build: async () =>
    await Promise.resolve()
      .then(() => _interopRequireWildcard(require("next/dist/cli/next-build")))
      .then((i) => i.nextBuild),
  start: async () =>
    await Promise.resolve()
      .then(() => _interopRequireWildcard(require("next/dist/cli/next-start")))
      .then((i) => i.nextStart),
  export: async () =>
    await Promise.resolve()
      .then(() => _interopRequireWildcard(require("next/dist/cli/next-export")))
      .then((i) => i.nextExport),
  dev: async () =>
    await Promise.resolve()
      .then(() => _interopRequireWildcard(require("next/dist/cli/next-dev")))
      .then((i) => i.nextDev),
  telemetry: async () =>
    await Promise.resolve()
      .then(() => _interopRequireWildcard(require("next/dist/cli/next-telemetry")))
