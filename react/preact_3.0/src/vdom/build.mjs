import { TEXT_CONTENT, EMPTY } from '../constants.mjs';
import { hasOwnProperty, empty, toArray } from '../util.mjs';
import { hook, deepHook } from '../hooks.mjs';
import { isSameNodeType } from './index.mjs';
import { buildFunctionalComponent } from './functional-component.mjs';
import { buildComponentFromVNode } from './component.mjs';
import { appendChildren, getAccessor, setAccessor, getNodeAttributes } from '../dom/index.mjs';
import { collectComponent } from './component-recycler.mjs';
